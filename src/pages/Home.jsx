...
function RevealSection({children,style={}}){
  ...
  return(
    <div ref={ref} style={{transition:"opacity .7s ease, transform .7s ease",opacity:visible?1:0,transform:visible?"none":"translateY(32px)",...style}}>
      {children}
    </div>
  );
}
  ...
  return(
    <div className={`pg ${s.wrap}`}>
      ...
      <section className={s.hero}>
        <div className={`${s.orb} ${s.o1}`}/><div className={`${s.orb} ${s.o2}`}/><div className={`${s.orb} ${s.o3}`}/>
